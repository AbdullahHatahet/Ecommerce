      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{request()->is('categories') ? 'menu-open':''}} {{request()->is('addcategory') ? 'menu-open':''}}">
            <a href="{{url('/categories')}}" class="nav-link {{request()->is('categories') ? 'active':''}} {{request()->is('addcategory') ? 'active':''}}">
          ...
          <li class="nav-item has-treeview {{request()->is('addslider') ? 'menu-open':''}} {{request()->is('sliders') ? 'menu-open':''}}">
            <a href="{{url('/sliders')}}" class="nav-link {{request()->is('addslider') ? 'active':''}} {{request()->is('sliders') ? 'active':''}}">
              <i class="nav-icon fas fa-folder"></i>
              <p>
                Sliders
                <i class="fas fa-angle-left right"></i>
          ...
          <li class="nav-item has-treeview {{request()->is('products') ? 'menu-open':''}} {{request()->is('addproduct') ? 'menu-open':''}}">
            <a href="{{url('/products')}}" class="nav-link {{request()->is('products') ? 'active':''}} {{request()->is('addproduct') ? 'active':''}}">
              <i class="nav-icon fas fa-folder"></i>
              <p>
                Products
                <i class="fas fa-angle-left right"></i>
